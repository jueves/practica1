...
```
Presuponemos que los tratamientos se enfocan a evitar la mortalidad en pacientes con cáncer colorrectal diagnosticado y que la unidad de tiempo son meses.
Ambos tratamientos presentan evoluciones muy parecidas hasta el mes 20, con una ligera ventaja para el tratamiento B. A partir de este momento la diferencia es mucho más marcada, atenuandose al aproximarse el mes 40 y perdiendose todos los sujetos del grupo con A poco después de este punto.

Podemos concluir que el tratamiento B es más efectivo para evitar la muerte por cáncer colorrectal entre los pacientes con este diagnóstico.
